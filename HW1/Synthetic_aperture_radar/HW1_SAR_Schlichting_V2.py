# The website does not provide unique url's for the data, it only pinpoints
# it by search region, even after using the GUI to click on a dataset. If I
# actually put the full url it gives me a 404. Minimal working example shown
# below.
# [https://search.asf.alaska.edu/#/?zoom=7.753333333333323&center=-94.092774,27.584951&polygon=POLYGON]

# Since this is a let down - I dug up some code to let you login to other NASA
# data. For example, see https://ladsweb.modaps.eosdis.nasa.gov/. The script
# below has a series of functions, given your earthdata username, password, and
# data url, will download the data for you. This would greatly speed up the
# process for biological oceanographers or chemists working with ocean color
# data, sea surface temperature, or other basic key ocean variables
